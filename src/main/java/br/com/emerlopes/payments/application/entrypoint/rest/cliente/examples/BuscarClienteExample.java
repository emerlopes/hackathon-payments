...
@Operation(
        ...
        description = "API para buscar um cliente específico pelo ID",
        responses = {
                @ApiResponse(
                        responseCode = "200",
                        description = "Resposta de sucesso",
                        content = @Content(
                                schema = @Schema(implementation = BuscarClienteResponseDTO.class),
                                        ...
                                        value = """
                                                {
                                                    ...
                                                    "details": "/api/clientes/{idCliente}"
                                                }
                                                """
                                )
                        )
...
public @interface BuscarClienteExample {
}