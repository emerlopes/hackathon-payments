...
@Operation(
        summary = "Buscar Cartões do Cliente",
        description = "API para buscar todos os cartões de crédito associados a um cliente específico",
        responses = {
                @ApiResponse(
                        responseCode = "200",
                        description = "Resposta de sucesso",
                        content = @Content(
                                schema = @Schema(implementation = BuscaCartaoResponseDTO.class),
                                examples = @ExampleObject(
                                        ...
                                        value = """
                                                [
                                                    {
                                                        "id_cartao": "a3673b09-753c-4bc6-bb20-6a44be61ab26",
...
public @interface BuscarCartoesClienteExample {
}
